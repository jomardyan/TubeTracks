...
class PluginRegistry:
    ...
    def find_plugin_for_url(self, url: str) -> Optional[Tuple[str, BaseConverter]]:
        ...
        if url in self._url_pattern_cache:
            ...
            return next((pid for pid, p in self._plugins.items() if p is plugin), None), plugin
    ...
    def get_plugins_by_content_type(self, content_type: ContentType) -> Dict[str, BaseConverter]:
